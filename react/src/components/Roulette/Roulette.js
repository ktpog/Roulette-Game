 ...
 * Inspired and adapted from @luca2849. Original repo can be found at: https://github.com/luca2849/react-roulette.
 */
constructor(props){super(props)};
    ...
    */
    ...
    pick_random_number = (obj) => {
        ...
        let random_key = keys[this.state.resultNum]; //winning number endpoint goes here
